...
void interactor::one_moving_interact (sphere & si, sphere & sj)
{
    ...
    if (dx*dx + constants::eps*constants::eps > (si.r + sj.r)*(si.r + sj.r))
        return;
...
void interactor::two_moving_interact (sphere & si, sphere & sj)
{
    // points from i to j
    vec3d dx = sj.x - si.x;
...
void interactor::interact (sphere & si, sphere & sj)
{
...
void interactor::interact (brick & b, sphere & s)
{
