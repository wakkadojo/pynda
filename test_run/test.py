...
bi = panda.interactor (0.5, 0.5)
dt = 0.001
w = panda.world (cell_size, bi, dt)

b = panda.brick (panda.vec3d (0.25, 0.0, 0.0), panda.vec3d (0.25, 0.25, 1.0))
w.add_brick (b)

r, m, I = 0.025, 0.025**2, 0.025**4/2

s = panda.sphere (r, m, I, panda.vec3d (), panda.vec3d (), panda.vec3d (0.0, 0.0, 10.0))
...
for i in range (500):
    ...
    if i % 10 == 0:
        ...
        x = panda.vec3d (-0.25, -0.05+0.1*random.random (), 0.0)
